...
# Downloads and runs setup/phase1-setup-windows.ps1 (non-admin checks + 1Password
# SSH key capture). Also saves setup/phase1-setup-windows-admin.ps1 locally for
# the elevated step.
#
...
Write-Host "  → Downloading setup/phase1-setup-windows.ps1..." -ForegroundColor Blue
Invoke-WebRequest "$raw/setup/phase1-setup-windows.ps1" -OutFile "$dest\phase1-setup-windows.ps1"

Write-Host "  → Downloading setup/phase1-setup-windows-admin.ps1..." -ForegroundColor Blue
Invoke-WebRequest "$raw/setup/phase1-setup-windows-admin.ps1" -OutFile "$dest\phase1-setup-windows-admin.ps1"
